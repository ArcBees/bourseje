...
public class HowToVotePresenter extends Presenter<HowToVotePresenter.MyView, HowToVotePresenter.MyProxy> {
    interface MyView extends View {
    }

    @ProxyStandard
    @NameToken(NameTokens.HOW_TO_VOTE)
    interface MyProxy extends ProxyPlace<HowToVotePresenter> {
    }
